...
var BlockModule = dogecore.Block;
var BinaryParser = dogecore.BinaryParser;
var Block;


var getBlock = function (onlyHeader) {

  var testnetMagic = dogecore.networks.testnet.magic.toString('hex');
...
describe('Block', function() {
  ...
  it('should be able to checkMerkleRoot', function() {
    ...
    dogecore.buffertools.toHex(b.calcMerkleRoot(b.txs)).should.equal(dogecore.buffertools.toHex(new Buffer(b.merkle_root)));
  ...
  it('should be able to checkProofOfWork', function() {
    ...
    b.hash = dogecore.buffertools.reverse(new Buffer('000000000b99b16390660d79fcc138d2ad0c89a0d044c4201a02bdf1f61ffa11', 'hex'));
    b.checkHash().should.equal(true);
    b.checkProofOfWork().should.equal(true);

    // wrong hash hash, ok proof of work
    b.hash = dogecore.buffertools.reverse(new Buffer('000000000000016390660d79fcc138d2ad0c89a0d044c4201a02bdf1f61ffa11', 'hex'));
    b.checkProofOfWork().should.equal(true);
    b.checkHash().should.equal(false);


    // wrong hash hash, wrong proof of work
    b.hash = dogecore.buffertools.reverse(new Buffer('0000000bbb99b16390660d79fcc138d2ad0c89a0d044c4201a02bdf1f61ffa11', 'hex'));
    b.checkHash().should.equal(false);
  ...
  it('should be able to get components from blocks', function() {
    ...
    dogecore.util.formatHashFull(b.getHash()).should.equal('000000000b99b16390660d79fcc138d2ad0c89a0d044c4201a02bdf1f61ffa11');

    dogecore.util.formatHashFull(b.getHeader()).should.equal('d6383bd51c3fffc051be10ce58e6d52d1eb00470ae1ab4d5a3375c0f51382c6f249fff84e9888286974cfc97000000003c35b5e70b13d5b938fef4e998a977c17bea978390273b7c50a9aa4b00000002');

    dogecore.util.formatHashFull(b.merkle_root).should.equal('58e6d52d1eb00470ae1ab4d5a3375c0f51382c6f249fff84e9888286974cfc97');

  });


  it('#getBlockValue should return the correct block value', function() {
    var c = dogecore.util.COIN;
    dogecore.Block.getBlockValue(0).div(c).toNumber().should.equal(50);
    dogecore.Block.getBlockValue(1).div(c).toNumber().should.equal(50);
    dogecore.Block.getBlockValue(209999).div(c).toNumber().should.equal(50);
    dogecore.Block.getBlockValue(210000).div(c).toNumber().should.equal(25);
    dogecore.Block.getBlockValue(2100000).toNumber().should.equal(4882812);
  });
